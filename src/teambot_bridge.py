"""
TeamBot browser-native bridge / direct-connect helpers.
"""
...
from teambot_runtime_store import get_bridge_session, list_bridge_sessions, upsert_bridge_session


class TeamBotBridgeHub:
...
def issue_bridge_session(
    *,
    ...
    role: str = "viewer",
    label: str = "",
    websocket_prefix: str = "/teambot/ws",
) -> dict[str, Any]:
