"""
TeamBot workflow presets and lightweight recovery hints.

The presets expose a browser-native version of reusable operating patterns
inspired by oh-my-codex / oh-my-openagent. They are stored as normal TeamBot
...
WORKFLOW_PRESETS: tuple[WorkflowPreset, ...] = (
    ...
    WorkflowPreset(
        ...
        notes="Best when multiple TeamBot subagents should coordinate through plan, inbox, and artifact surfaces.",
