...
from teambot_buddy import apply_buddy_action, ensure_buddy_state, get_buddy_state
from teambot_voice import get_voice_state


class TeamBotBuddyTests(unittest.TestCase):
...
class TeamBotVoiceTests(unittest.TestCase):
